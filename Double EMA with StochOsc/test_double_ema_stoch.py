...
def test_double_ema_stoch_strategy(file_path: str):
    """Test Double EMA with Stochastic Strategy with trade visualization"""
    # Load market data
    ...
    fig, axes = mpf.plot(
        ...
        type='candle',
        style=style,
        title='Double EMA Stochastic Strategy Trades',
        addplot=apds,
        volume=False,
        figsize=(20, 10),
...
if __name__ == "__main__":
    file_path = r"F:\Algo Trading TRAINING\Strategy backtests\data\bybit-ETHUSDT-5m-20240929-to-20241128.csv"
