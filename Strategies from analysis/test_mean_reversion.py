...
def test_mean_reversion_strategy(file_path: str):
    """Test Mean Reversion Strategy with trade visualization"""
    # Load market data
    ...
    print(f"Number of trade_exits: {len(strategy.trade_exits)}")
    for i, trade in enumerate(strategy.trade_exits):
        print(f"\nTrade {i + 1}:")
